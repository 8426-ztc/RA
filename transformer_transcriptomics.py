...
output_dir = "results/transcriptomics_analysis_output" 
...
input_data_file = 'data/transcriptomics_dataset.xlsx'
...
class TransformerModel(nn.Module):
    def __init__(self, input_dim, dropout_rate=0.5):  # Increased dropout
        ...
        # - 6 attention heads: balances model capacity and computational efficiency
...
# Compute overall AUC from concatenated predictions
...
plt.title('Transcriptomics Precision-Recall Curve')
...
plt.title('Transcriptomics Calibration Curve (Reliability Diagram)')
plt.legend(loc="lower right")
plt.grid(True)
plt.tight_layout()
...
top_30_indices = sorted_indices[:30]  # Top 30 genes based on importance ranking
