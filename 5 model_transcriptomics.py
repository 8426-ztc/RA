...
print(f"Environment ready. Starting the 'single-track' rigorous analysis pipeline.")

# =============================================================================
# 1. Global Configuration
# =============================================================================
# !!! Modify these variables for your dataset !!!
# Path to the input dataset (e.g., Metabolomics or Transcriptomics data)
INPUT_FILE = "data/your_input_file.xlsx" 

# Directory to save adjusted results and plots
...
# Model color scheme (Macaron Palette)
MODEL_COLORS = {
    "KNN": (137/255, 207/255, 240/255),      # Baby Blue
    "SVM": (255/255, 182/255, 193/255),      # Pastel Pink
    "RF": (152/255, 251/255, 152/255),       # Mint Green
    "RFE-RF": (255/255, 218/255, 185/255),   # Peach
    "XGBoost": (199/255, 177/255, 229/255)   # Lavender
}
...
try:
    ...
    print(f"Error: File '{INPUT_FILE}' not found. Please ensure the path is correct.")
    exit()
...
# =============================================================================
print("\n[Step 2/6] Executing core analysis workflow...")
...
# Model configuration with conservative tuning for small sample stability
models = {
...
for model_name in models_order:
    ...
    print(f"  Performance evaluation complete. AUC: {all_model_metrics[model_name]['AUC']:.3f}")
    ...
    print(f"  Feature importance calculated and saved.")
...
print("\n--- Model Performance Comparison (from 10-fold CV) ---")
...
print("\n--- Frequency of Top 10 Features Across Models ---")
print(consistency_df)
consistency_df.to_excel(os.path.join(OUTPUT_DIR, "Feature_Consistency_Analysis.xlsx"))

# =============================================================================
# 5. Visualization Part 1: Standalone ROC Curves
# =============================================================================
print("\n[Step 4/6] Generating standalone overall ROC curves...")
...
ax_roc.set(xlim=[-0.02, 1.0], ylim=[0.0, 1.05],
           ...
           title=f'ROC Curves Comparison (from {N_SPLITS}-fold CV)')
...
print("Standalone ROC curve saved.")
plt.show()
plt.close()

# =============================================================================
# 6. Viz Part 2: Integrated Plot (Importance + Performance Table)
# =============================================================================
print("\n[Step 5/6] Generating integrated charts (Feature Importance + Performance Summary)...")
...
# Plotting the Performance Summary Table
...
print("Integrated charts (Importance + Performance) saved.")
plt.show()
plt.close()

# =============================================================================
# 7. Viz Part 3: Standalone Feature Consistency Matrix
# =============================================================================
print("\n[Step 6/6] Generating standalone feature consistency matrix...")
...
if num_features_to_plot > 0:
    ...
    ax.text(0.5, 0.5, "No features consistently found in Top 10.", ha='center', va='center', transform=ax.transAxes)
    ax.set_axis_off()
...
print("Standalone feature consistency plot saved.")
plt.show()
plt.close()

print(f"\nAll analyses complete. All results saved to:\n{OUTPUT_DIR}")